...
#ifndef infinity_JITASSEMBLER_H
#define infinity_JITASSEMBLER_H
...
private:
    ...
    static infinityObject* jitNewObject(x86int_t size);
    static infinityObject* jitNewObject2(x86int_t size);
    static infinityObject* jitNewClass0(x86int_t classid);
    static infinityObject* jitNewClass1(x86int_t size, x86int_t classid);
    static void jitNewString(Thread* thread, int64_t strid);
    static void jitPushNil(Thread* thread);
    static void jitSetObject0(infinityObject* o, StackElement *sp);
    static void jitSetObject1(StackElement*, StackElement*);
    static void jitSetObject2(Object *dest, Object *src);
    static void jitSetObject3(Object *dest, infinityObject *src);
    ...
    void setupinfinityObjectFields();
    int compile(Method*);
    ...
    x86::Mem Linfinity_object[4];    // memory layout of struct infinityObject {}
};
...
// struct infinityObject {} fields
#define infinity_object_HEAD 0
#define infinity_object_node 1
#define infinity_object_size 2
#define infinity_object_info 3
