//
//Created by Rohit Maurya 10/11/2019.
//

#ifndef infinity_PARSER_H
#define infinity_PARSER_H
...
#define _infinity_CERROR_LIMIT c_options.error_limit

#define CHECK_ERRLMT(exit_proc) \
    if(panic) exit_proc \
    else if(errors->getUnfilteredErrorCount() > _infinity_CERROR_LIMIT) { \
        panic = true; \
        exit_proc \
    }
