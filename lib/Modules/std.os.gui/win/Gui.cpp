...
void Gui::winGuiIntf(long long proc) {
    switch(proc) {
        ...
        case _g_dwnd: {
            ...
            infinityObject* name = (self->sp--)->object.object;
            infinityObject* title = (self->sp--)->object.object;
...
void Gui::winPaint(long long proc) {
    ...
    switch(proc) {
        case _pt_text: {
            infinityObject* str = (self->sp--)->object.object;
            if(str) {
...
bool Gui::createPolygon(Poly *poly) {
    Thread* self = thread_self;
    infinityObject *polygonObject = (self->sp)->object.object;
